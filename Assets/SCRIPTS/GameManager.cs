...
public class GameManager : MonoBehaviour
{
	...
	*/
    ...
    public void P1CalibrationStart()
    {
        if (PlayerInfo1.PJ == null)
        {
            Player1CalibrationStartUI.SetActive(false);
            Player1CalibrationUnloadUI.SetActive(true);
            PlayerInfo1 = new PlayerInfo(0, Player1);
            PlayerInfo1.LadoAct = Visualizacion.Lado.Izq;
            SetPosicion(PlayerInfo1);
            Debug.Log("check");
            if(PlayerInfo2.PJ == null && currentGamemode == Gamemode.singleplayer)
            {
                PlayerInfo2 = new PlayerInfo(1, Player2);
                PlayerInfo2.LadoAct = Visualizacion.Lado.Der;
                SetPosicion(PlayerInfo2);
    ...
    public void P2CalibrationStart()
    {
        if (PlayerInfo2.PJ == null && currentGamemode == Gamemode.multiplayer)
        {
            Player2CalibrationStartUI.SetActive(false);
            Player2CalibrationUnloadUI.SetActive(true);
            PlayerInfo2 = new PlayerInfo(1, Player2);
            PlayerInfo2.LadoAct = Visualizacion.Lado.Der;
            SetPosicion(PlayerInfo2);
        }
    ...
    public void IniciarCalibracion()
    {
        ...
        Player1CalibrationUnloadUI.SetActive(false);
#endif
...
#endif
#if UNITY_IOS || UNITY_ANDROID
            Player2CalibrationUnloadUI.SetActive(false);
#endif
	...
	*/
    ...
    public void FinCalibracion(int playerID)
    {
        ...
        else if (playerID == 1 && currentGamemode == Gamemode.multiplayer)
        {
            PlayerInfo2.FinTuto1 = true;
#if UNITY_IOS || UNITY_ANDROID
            Player2CalibrationUI.SetActive(true);
#endif
        }
